...
**Do NOT use interactive buttons (`send_interactive_buttons`).**
All WhatsApp menus must be strictly **Text-Based** (numeric or keyword replies).
Example: Instead of sending buttons for "Approve/Reject", send a text message:
