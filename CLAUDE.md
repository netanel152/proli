...
Expected: **311 passed, 6 skipped** (integration tests skipped without `MONGO_TEST_URI`). The authoritative baseline lives in `docs/TESTING.md` ("Current status" line).
